...
public class Imgproc {
    ...
    //javadoc: createGeneralizedHoughBallard()
    public static GeneralizedHoughBallard createGeneralizedHoughBallard()
    {
        
        GeneralizedHoughBallard retVal = GeneralizedHoughBallard.__fromPtr__(createGeneralizedHoughBallard_0());
    ...
    //javadoc: createGeneralizedHoughGuil()
