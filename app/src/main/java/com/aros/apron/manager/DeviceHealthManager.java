...
public class DeviceHealthManager extends BaseManager {
    ...
    public void initDeviceHealth(MqttAndroidClient client) {
        ...
        if (isConnect != null && isConnect) {
            ...
            IDeviceHealthManager iDeviceHealthManager = dji.v5.manager.diagnostic.DeviceHealthManager.getInstance();
    ...
    private void publishHealthInfo2Server() {
        if (isFlyClickTime()) {
            ...
            try {
//                Log.e("推送DeviceHealth状态", new Gson().toJson(DeviceHealthEntity.getInstance()));
