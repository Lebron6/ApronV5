...
public class BatteryStateAEntity {
    private static class MovementHolder {
        private static final BatteryStateAEntity INSTANCE = new BatteryStateAEntity();
    }

    private BatteryStateAEntity() {
    }

    public static final BatteryStateAEntity getInstance() {
        return BatteryStateAEntity.MovementHolder.INSTANCE;
    }
